...
// This thin shim is what makes `npx wrst init ...` work before a project exists:
// npx fetches `wrst` (+ its @wrst/cli dependency) and runs this, which hands off
// to the CLI with the same argv.
